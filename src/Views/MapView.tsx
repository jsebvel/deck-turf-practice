...
const restaurants = [
  {
    position: [-75.5175, 5.0689],
    name: "La Terraza Gourmet",
    type: "restaurant",
    address: "Calle 23 #25-41, Manizales",
    phone: "(6) 887 4521",
  },
  {
    position: [-75.5142, 5.0702],
    name: "El Buen Sabor",
    type: "restaurant",
    address: "Carrera 23 #30-15, Manizales",
    phone: "(6) 883 2190",
  },
  {
    position: [-75.5201, 5.0665],
    name: "Restaurante Los Nevados",
    type: "restaurant",
    address: "Avenida Santander #45-20, Manizales",
    phone: "(6) 885 6734",
  },
  {
    position: [-75.5189, 5.0712],
    name: "Café de la Montaña",
    type: "restaurant",
    address: "Calle 31 #22-10, Manizales",
    phone: "(6) 889 1023",
  },
  {
    position: [-75.5163, 5.0681],
    name: "Parrilla El Fogón",
    type: "restaurant",
    address: "Carrera 25 #27-33, Manizales",
    phone: "(6) 884 5678",
  },
  {
    position: [-75.5088, 5.0492],
    name: "Restaurante Villa María",
    type: "restaurant",
    address: "Calle 10 #5-22, Villamaría",
    phone: "(6) 859 3412",
  },
  {
    position: [-75.5102, 5.0478],
    name: "El Rincón Caldense",
    type: "restaurant",
    address: "Carrera 8 #12-45, Villamaría",
    phone: "(6) 859 7821",
  },
  {
    position: [-75.5121, 5.0505],
    name: "Sabores del Eje",
    type: "restaurant",
    address: "Calle 15 #10-30, Villamaría",
    phone: "(6) 859 4567",
  },
  {
    position: [-75.5195, 5.0698],
    name: "Pizza y Pasta",
    type: "restaurant",
    address: "Calle 28 #20-18, Manizales",
    phone: "(6) 886 2345",
  },
  {
    position: [-75.5156, 5.0673],
    name: "Asados Don Pepe",
    type: "restaurant",
    address: "Carrera 24 #26-50, Manizales",
    phone: "(6) 888 9012",
  },
];
...
const MapView = () => {
  ...
  const [clientPosition, setClientPosition] = useState<[number, number] | null>(
    null
  );
  ...
  const lineToRestaurant = useMemo(() => {
    if (!clientPosition) {
      return [];
    }
    const lines = availableRestaurants?.map((rest) =>
      lineString([clientPosition, rest.properties.position])
    );
  ...
  const layers = [
    ...
    new LineLayer({
      ...
      data: nearestRestaurantLine ? [nearestRestaurantLine] : [],
      getSourcePosition: (d) => d.geometry.coordinates[0],
      getTargetPosition: (d) => d.geometry.coordinates[1],
      getColor: [255, 0, 0],
      getWidth: 4,
    ...
    <TooltipProvider>
      <div style={{ width: "100vw", height: "100vh", position: "relative" }}>
        <DeckGL
          ...
          onClick={(e) =>
            setClientPosition(
              point(e.coordinate!).geometry.coordinates as [number, number]
            )
          }
        >
        ...
        <div className="absolute ml-4 items-start text-justify ">
          ...
          >
            {showBuffers ? (
              ...
              <EyeClosed className="mr-2 text-white" />
            )}
          </Toggle>
              ...
              {availableRestaurants.map((restaurant) => (
                <div className="mb-4">
                  ...
                  <div className="text-sm">
                    {restaurant?.properties?.distance.toFixed(2)} km
                  </div>
                  <div className="text-sm">
